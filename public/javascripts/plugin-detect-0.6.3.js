...
if (!PluginDetect) {
    var PluginDetect = {
        ...
        findNavPlugin: function(g, d) {
            var a = g.constructor == String ? g : g.join(".*"),
                e = d === false ? "" : "\\d",
...
PluginDetect.java = {
    ...
    queryJava: function() {
        ...
        if (typeof window.java != "undefined" && navigator.javaEnabled() && !c.hasRun) {
            if (d.isGecko) {
                ...
                if ((/opera.9\.(0|1)/i).test(b) && (/mac/i).test(b)) {} else {
                    if (!c.hasRun) {
                        c.queryJavaHandler()
                    }
                }
    ...
    getInfo: function() {
        ...
        m = {
            ...
            DeployTK_versions: [],
            MimeType_versions: [],
            DeploymentToolkitPlugin: (a.queryDTKresult == 0 ? false : true),
            vendor: (typeof a.vendor == "string" ? a.vendor : ""),
            OTF: (a.OTF < 3 ? 0 : (a.OTF == 3 ? 1 : 2))
        };
        ...
        var c = m.All_versions,
            k = m.DeployTK_versions,
            f = m.MimeType_versions,
            b = a.JavaPlugin_versions;
