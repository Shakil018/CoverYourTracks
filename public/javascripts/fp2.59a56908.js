parcelRequire = function(e, r, t, n) {
    ...
    "llUH": [function(require, module, exports) {
        var define;
        var e;
        ! function(t, n, a) {
            "use strict";
            "undefined" != typeof window && "function" == typeof e && e.amd ? e(a) : "undefined" != typeof module && module.exports ? module.exports = a() : n.exports ? n.exports = a() : n.Fingerprint2 = a()
        }(0, this, function() {
            "use strict";
            ...
            var e = function(e, t) {
                ...
                d = function(e) {
                    ...
                    var screenHeight_id = document.getElementById("screenHeight_id");
                    screenHeight_id.textContent = "Screen Height: " + window.screen.height;
                
                    var screenWidth_id = document.getElementById("screenWidth_id");
                    screenWidth_id.textContent = "Screen Width: " + window.screen.width;
                ...
                f = function(e) {
                    if (window.screen.availWidth && window.screen.availHeight) {
                        ...
                        console.log(`window screen availHeight: ${window.screen.availHeight}, availWidth: ${window.screen.availWidth} `);
                        
                        var availHeight_id = document.getElementById("availHeight_id");
                        availHeight_id.textContent = "AvailHeight: " + window.screen.availHeight;
                    
                        var availWidth_id = document.getElementById("availWidth_id");
                        availWidth_id.textContent = "AvailWidth: " + window.screen.availWidth;
                ...
                E = function() {
                    ...
                    // console.log("supported extensions: ", e.getSupportedExtensions());
                    // console.log("this is e: ", e);

                    try {
                        // var c = e.getExtension("WEBGL_debug_renderer_info");
                        var c = e.getExtension("RENDERER");
                ...
                x = function() {
                    try {
                        var e = G(),
                            ...
                            t = e.getExtension("RENDERER"),

                            n = e.getParameter(t.UNMASKED_VENDOR_WEBGL) + "~" + e.getParameter(t.UNMASKED_RENDERER_WEBGL);
                            console.log("UNMASKED_VENDOR_WEBGL: ", t.UNMASKED_VENDOR_WEBGL);
                            console.log("UNMASKED_RENDERER_WEBGL: ", t.UNMASKED_RENDERER_WEBGL);
                        return U(e), n
                    } catch (a) {
                        return null
                    }
                ...
                M = function() {
                    if (void 0 !== navigator.languages) try {
                        console.log("all langs: ", navigator.languages);
                ...
                b = function() {
                    var e, t = navigator.userAgent.toLowerCase(),
                        ...
                        var userAgent = document.getElementById("userAgent_id");
                        userAgent.textContent = "Web Driver: " + navigator.userAgent;
                ...
                k = function() {
                    ...
                    var e = G(),
                        ...
                        console.log(`WebGL rendering context: ${window.WebGLRenderingContext}`)
                    return U(e), t
                },
                D = function() {
                ...
                F = function(e, t) {
                    ...
                    window.swfobject.embedSWF(t.fonts.swfPath, n, "1", "1", "9.0.0", !1, a, {
                ...
                G = function() {
                    ...
                    try {
                        ...
                        console.log("webgl extension maybe: ", t);

                        var webgl = document.getElementById("webGL_id");
                        ...
                        //console.log("idk what is this: ", t["drawingBufferHeight"]);

                        webgl.textContent = "WebGL: " + count;

                        console.log("before writing");

                        var overwrite = document.getElementById("overwrite_id");
                        var canvas = document.getElementById("myCanvas_id");

                        var getIns = document.getElementById("getInstrumentJS_id"); 
                        getIns.textContent = "Get Instrument JS: " + window.getInstrumentJS;


                        overwrite.textContent = "window.canvas.getContext.toString(): " + canvas.getContext.toString();

                        var jsIns = document.getElementById("jsInstruments_id"); 
                        jsIns.textContent = "JS instrument: " + window.jsInstruments;


                        var insApi = document.getElementById("instrumentFingerprintingApis_id"); 
                        insApi.textContent = "instrumentFingerprintingApis: " + window.instrumentFingerprintingApis;
                        // insApi.textContent = "JSInstrumentRequest: " + windows.JSInstrumentRequest;
                ...
                V = [{
                    ...
                    getData: function(e, t) {
                        ...
                        var Webdriver = document.getElementById("webdriver_id");
                        Webdriver.textContent = "Web Driver: " + navigator.webdriver;
                    ...
                    getData: function(e, t) {
                        ...
                        var userLanguage = document.getElementById("userLanguage_id");
                        userLanguage.textContent = "user Language: " + e(navigator.language || navigator.userLanguage || navigator.browserLanguage || navigator.systemLanguage || t.NOT_AVAILABLE);
                    ...
                    getData: function(e, t) {
                        ...
                        var colorDepth = document.getElementById("colorDepth_id");
                        colorDepth.textContent = "Color Depth: " + window.screen.colorDepth;
                    ...
                    getData: function(e, t) {
                        console.log(`hardwareConcurrency: ${e(v(t))}`);
                        
                        var hardwareConcurrency = document.getElementById("hardware_id");
                        hardwareConcurrency.textContent = "Hardware Concurrency: " + e(v(t));
                    ...
                    getData: function(e, t) {
                        console.log(`screenResolution: ${e(d(t))}`);
                    ...
                    getData: function(e, t) {
                        console.log(`availableScreenResolution: ${e(f(t))}`);
                    ...
                    key: "timezoneOffset",
                    getData: function(e) {
                        console.log(`timezoneOffset: ${e((new Date).getTimezoneOffset())}`);
                    ...
                    key: "timezone",
                    getData: function(e, t) {
                        console.log(`timezone: ${e((new window.Intl.DateTimeFormat).resolvedOptions().timeZone || t.NOT_AVAILABLE)}`);
                    ...
                    key: "sessionStorage",
                    getData: function(e, t) {
                        console.log(`sessionStorage: ${e(p(t))}`);
                    ...
                    key: "localStorage",
                    getData: function(e, t) {
                        console.log(`localStorage: ${e(T(t))}`);
                    ...
                    getData: function(e, t) {
                        ...
                        var val = D() ? t.plugins.excludeIE ? e(t.EXCLUDED) : e(h(t)) : e(g(t))


                        console.log(`plugins.excludeIE: ${val}`);
                    ...
                    key: "canvas",
                    getData: function(e, t) {
                        var val = I() ? e(y(t)) : e(t.NOT_AVAILABLE);
                    ...
                    getData: function(e, t) {
                        ...
                        var val = k() ? e(E()) : e(t.NOT_AVAILABLE)

                        console.log(`webgl: ${val}`);
                    ...
                    getData: function(e) {
                        var val = k() ? e(x()) : e()
                        console.log(`webglVendorAndRenderer: ${val}`);
                    ...
                    getData: function(e) {
                        console.log(`hasLiedLanguages: ${e(M())}`);
                    ...
                    getData: function(e) {
                        console.log(`hasLiedResolution: ${e(P())}`);
                    ...
                    key: "hasLiedBrowser",
                    getData: function(e) {
                        console.log(`hasLiedBrowser: ${e(L())}`);
                    ...
                    key: "touchSupport",
                    getData: function(e) {
                        console.log(`hasLiedBrowser: ${e(B())}`);
                        e(B())
                    }
                }, {
                    key: "fonts",
                    getData: function(e, t) {
                        ...
                        var r = document.getElementsByTagName("body")[0],
                            ...
                            u = function(e, t) {
                                var n = c();
                                //console.log(`fontFamily: ${n.style.fontFamily}`);
...
//# sourceMappingURL=/static/dist/fp2.59a56908.js.map